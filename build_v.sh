...
# ===== 设置自定义参数 =====
MANIFEST=${MANIFEST:-gt5pro}
CUSTOM_SUFFIX=${CUSTOM_SUFFIX:-android14-11-o-v$(date +%Y%m%d)}
...
# ===== lz4 & zstd 补丁 =====
echo ">>> 应用 lz4 & zstd 补丁..."
curl -LSs --remote-name "https://raw.githubusercontent.com/ferstar/kernel_manifest/refs/heads/realme/sm8650/patches/001-lz4.patch"
patch -p1 < 001-lz4.patch || true
curl -LSs --remote-name "https://raw.githubusercontent.com/ferstar/kernel_manifest/refs/heads/realme/sm8650/patches/002-zstd.patch"
